mapboxgl.accessToken = 'pk.eyJ1IjoicnV6bWlzaGFlbCIsImEiOiJjbG5yNjUzZTYwb3lmMmpwa200NndlNTNrIn0.DH2ARNo09iLGylY8SuiNwg';
        ...
        map.on('load', function () {
            ...
            map.addSource('line3', {
                type: 'geojson',
                data: 'geoJSON/line3.geojson'
            });

            map.addSource('univ_line1', {
                type: 'geojson',
                data: 'geoJSON/univ_line1.geojson'
            });

            map.addSource('univ_line2', {
                type: 'geojson',
                data: 'geoJSON/univ_line2.geojson'
            });

            map.addSource('univ_line3', {
                type: 'geojson',
                data: 'geoJSON/univ_line3.geojson'
            });

            map.loadImage('Images/icon-univ.png', function (error, image) {
                if (error) throw error;
                map.addImage('univ_line-icon', image);
            });
            map.addSource('hospi_line1', {
                type: 'geojson',
                data: 'geoJSON/hospi_line1.geojson'
            });

            map.addSource('hospi_line2', {
                type: 'geojson',
                data: 'geoJSON/hospi_line2.geojson'
            });

            map.addSource('hospi_line3', {
                type: 'geojson',
                data: 'geoJSON/hospi_line3.geojson'
            });

            map.loadImage('Images/icon-hospi.png', function (error, image) {
                if (error) throw error;
            ...
            map.addSource('route_line1', {
                type: 'geojson',
                data: 'geoJSON/route_line1.geojson'
            });

            map.addSource('route_line2', {
                type: 'geojson',
                data: 'geoJSON/route_line2.geojson'
            });

            map.addSource('route_line3', {
                type: 'geojson',
                data: 'geoJSON/route_line3.geojson'
            });
            ...
            switch (lineId) {
                case 'line1':
                    content = '<h2>LRT-1 (1984)</h2>' +
                        ...
                        '<img src="Images/lrt1.jpg" alt="LRT-1 First Gen Train" style="width: 100%; height: auto;">'+
                        ...
                        '<img src="Images/graph_lrt1.png" alt="LRT-1 Ridership" style="width: 100%; height: auto;">'+
               ...
               case 'line2':
                    content = '<h2>LRT-2 (2003)</h2>' +
                        ...
                        '<img src="Images/lrt2.jpg" alt="LRT-2 or the Megatren" style="width: 100%; height: auto;">'+
                        ...
                        '<img src="Images/graph_lrt2.png" alt="LRT-2 or the Megatren" style="width: 100%; height: auto;">'+
                ...
                case 'line3':
                    content = '<h2>MRT-3 (1999)</h2>' +
                        ...
                        '<img src="Images/mrt3.jpg" alt="MRT-3 train" style="width:100%; height: auto;">'+
                        ...
                        '<img src="Images/graph_mrt3.png" alt="Ridership Graph" style="width:100%; height: auto;">'+
                ...
                case 'all':
                    content = '<h2>Importance</h2>' +
                        ...
                        '<img src="Images/linechart.png" alt="Ridership Graph" style="width:100%; height: auto;">'+
